...
@section('content')
    ...
    <form class="form-floating text-center m-auto text-capitalize w-100 mt-2 overflow-hidden"
        action="{{ route('machines.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row  m-2">
